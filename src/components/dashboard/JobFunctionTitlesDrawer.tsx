...
import type { TitleData, TitleDrilldownData } from '@/hooks/useJobSeniorityMatrix';
      ...
      <SheetContent className="w-full sm:max-w-2xl">
        <SheetHeader className="space-y-1">
          ...
          <SheetDescription className="text-sm text-muted-foreground">
            Actual job titles served in this function, resolved from LinkedIn's Standardized Titles API.
          </SheetDescription>
        </SheetHeader>
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredTitles.map((title, idx) => (
                      <TableRow key={`${title.titleId}-${idx}`}>
